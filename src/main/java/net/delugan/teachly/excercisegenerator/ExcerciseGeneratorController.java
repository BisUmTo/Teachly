...
class ExcerciseGeneratorController {
    ...
    public ExcerciseGeneratorController(ExcerciseGeneratorRepository excerciseGeneratorRepository, ExcerciseRepository excerciseRepository, UserRepository userRepository) {
